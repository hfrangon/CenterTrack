...
class MobileNetV2(nn.Module):
    def __init__(self, opt,
        ...
        torchvision.utils.download_model(model_urls['mobilenet_v2'], model_dir="./", model_name="mobilenet_v2.pth")
        #state_dict = load_state_dict_from_url(model_urls['mobilenet_v2'])
        self.load_state_dict(torch.load("./mobilenet_v2.pth"), strict=False)
